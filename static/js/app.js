...
function appendTable(name) {
    ...
    Plotly.d3.json(url_years, function(error, yearsData) {
        ...
        // define the layout
        var layout = {
            title: `Numbers of Asylum, Refugee and Battle Deaths Since 1990 in ${name}`,
            xaxis: {
                title: "Years",
                tickfont: {
                    size: 14,
    ...
    Plotly.d3.json(url_years, function(error, yearsData) {
        ...
        let chart = new Chart({
            parent: "#plotChart",
            title: `Asylum, Refugee, and Battle Deaths Since 1990 in ${name}`,
            data: data,
            type: 'line',
            height: 400,
            // width: 1000,
    ...
    Plotly.d3.json(url_years, function(error, yearsData) {
        ...
        var layout = {
            height: 500,
            width: 1150,
            title: `Total Numbers of Asylum, Refugee and Battle Deaths Since 1990 in ${name}`
